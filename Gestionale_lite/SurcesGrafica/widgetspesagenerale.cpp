...
WidgetSpesaGenerale::WidgetSpesaGenerale(Societa *a, Spesa_generale *b, QWidget *parent) : QWidget(parent){
    ...
    LabelTipo->setText("Spesa Generale");
    ...
    LabelCausale=new QLabel("Causale: "+PointerSpesa->GetInformazione(),this);
...
void WidgetSpesaGenerale::SetPagato(){
...
void WidgetSpesaGenerale::Elimina(){
