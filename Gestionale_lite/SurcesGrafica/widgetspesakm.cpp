...
WidgetSpesaKm::WidgetSpesaKm(Societa *a, Spesa_Km *b, QWidget *parent)
    : QWidget(parent){
    ...
    LabelCausale=new QLabel("Destinazione: "+PointerSpesa->GetInformazione()+"("+
                            QString::number(PointerSpesa->GetKm_percorsi())+"km)",this);
